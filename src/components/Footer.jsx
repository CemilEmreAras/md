      ...
      <div className="container mx-auto">
        <div className="footer p-10">
          <div>
            ...
            <a className="link link-hover">Sık Sorulan Sorular</a>
            <a className="link link-hover">Gizlilik Politikası</a>
          </div>
          <div>
            <span className="footer-title">Eğitimler</span>
            <a className="link link-hover">Bilgisayar İşletmeni</a>
            <a className="link link-hover">Yazılım Geliştirme</a>
            <a className="link link-hover">Online Eğitimler</a>
            <a className="link link-hover">Eğitim Takvimi</a>
          </div>
          <div>
            <span className="footer-title">İletişim</span>
            <a className="link link-hover">Tel: +90 (212) 123 45 67</a>
            <a className="link link-hover">E-posta: info@akademi.com</a>
            <a className="link link-hover">Adres: Atatürk Cad. No:123</a>
            <a className="link link-hover">Merkez/İSTANBUL</a>
          </div>
          <div>
